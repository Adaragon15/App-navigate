...
export const Navbar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="main-header navbar navbar-expand theme-bg-primary theme-text-primary">
          ...
          <li className="nav-item">
            ...
            >
              <img
                ...
                alt="Theme Icon"
              // style={{
              //   filter: isDarkMode ? 'invert(100%)' : 'none', // para mejor contraste en modo oscuro
              // }}
              />
            </button>
          </li>
